...
This functionality is only available to users with the [isAdmin](/user-guide/getting-started/glossary.md#jwt-attributes) role. Platform Administrators have full access to create, edit, publish, and manage all Kata content.
:::
