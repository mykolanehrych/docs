...
For detailed instructions, see [Automated Deployment](./automated-deployment.md).
...
For step-by-step manual deployment instructions, see [Manual Deployment](./manual-deployment.md).
